...
namespace osiris
{
	...
	class programa_principal
	{
		...
		[Widget] Gtk.Image imagelogin = null;
		[Widget] Gtk.ComboBox combobox_sucursal = null;
		
		// menu principal OSIRS
		// HIS
		[Widget] Gtk.Window menuprincipal = null;
		
		[Widget] Gtk.Button button_cargos_hospital = null;
		[Widget] Gtk.MenuItem menuitem_hosp = null;
		[Widget] Gtk.MenuItem menuitem_hosp_paciente = null;
		[Widget] Gtk.MenuItem menuitem_hosp_rpt = null;
		[Widget] Gtk.MenuItem menuitem_hosp_rpt1 = null;
		[Widget] Gtk.MenuItem menuitem_hosp_rpt2 = null;
		[Widget] Gtk.MenuItem menuitem_hosp_rpt3 = null;
		...
		[Widget] Gtk.MenuItem menuitem_consulta_paciente = null;
		...
		[Widget] Gtk.MenuItem menuitem_optica = null;
		[Widget] Gtk.MenuItem menuitem_optica_paciente = null;
		[Widget] Gtk.MenuItem menuitem_optica_solicitud = null;
		[Widget] Gtk.MenuItem menuitem_optica_devolucion = null;
		[Widget] Gtk.MenuItem menuitem_optica_traspaso = null;
		[Widget] Gtk.MenuItem menuitem_optica_inv = null;
		[Widget] Gtk.MenuItem menuitem_optica_requi = null;
		
		[Widget] Gtk.Button button_odontologia = null;
		[Widget] Gtk.MenuItem menuitem_odontologia = null;
		[Widget] Gtk.MenuItem menuitem_odonto_paciente = null;
		[Widget] Gtk.MenuItem menuitem_odontologia_solicitud = null;
		[Widget] Gtk.MenuItem menuitem_odontologia_requi = null;
		
		// ERP
		[Widget] Gtk.Button button_afiliados = null;
		[Widget] Gtk.MenuItem menuitem_afiliados = null;
		
		[Widget] Gtk.Button button_registro_admision = null;
		[Widget] Gtk.MenuItem menuitem_admision = null;
		[Widget] Gtk.MenuItem menuitem_admision_registro = null;
		[Widget] Gtk.MenuItem menuitem_admision_citas = null;
		[Widget] Gtk.MenuItem menuitem_admision_docadmision = null;
		
		[Widget] Gtk.Button button_caja = null;
		[Widget] Gtk.MenuItem menuitem_tesoreria = null;
		[Widget] Gtk.MenuItem menuitem_tesoreria_caja = null;
		[Widget] Gtk.MenuItem menuitem_tesoreria_facturador = null;
		
		[Widget] Gtk.Button button_compras = null;
		[Widget] Gtk.MenuItem menuitem_compras = null;
		
		[Widget] Gtk.Button button_almacen = null;
		[Widget] Gtk.MenuItem menuitem_almacen = null;
		[Widget] Gtk.MenuItem menuitem_almacen_invfisico = null;
		[Widget] Gtk.MenuItem menuitem_almacen_invgeneral = null;
		[Widget] Gtk.MenuItem menuitem_almacen_invajuste = null;
		[Widget] Gtk.MenuItem menuitem_almacen_invtraspaso = null;
		
		[Widget] Gtk.Button button_costos = null;
		[Widget] Gtk.MenuItem menuitem_costos = null;
		[Widget] Gtk.MenuItem menuitem_costo_movprod = null;
		[Widget] Gtk.MenuItem menuitem_costo_prodproce = null;
		[Widget] Gtk.MenuItem menuitem_costo_costoproc = null;
		[Widget] Gtk.MenuItem menuitem_costo_analisiscargos = null;
		[Widget] Gtk.MenuItem menuitem_costo_listaprecio = null;
		[Widget] Gtk.MenuItem menuitem_costo_catalogoprod = null;
			
		[Widget] Gtk.Button button_proveedores = null;
		[Widget] Gtk.MenuItem menuitem_proveedores = null;
		
		[Widget] Gtk.Button button_credito_cobranza = null;
		[Widget] Gtk.MenuItem menuitem_credcobranza = null;
		[Widget] Gtk.MenuItem menuitem_credcbr_gestioncobranza = null;
		[Widget] Gtk.MenuItem menuitem_credcbr_pagofacturas = null;
		[Widget] Gtk.MenuItem menuitem_credcbr_convecuotas = null;
		[Widget] Gtk.MenuItem menuitem_credcbr_docxvencer = null;
		[Widget] Gtk.MenuItem menuitem_credcbr_docvencido = null;
		[Widget] Gtk.MenuItem menuitem_credcbr_juridico = null;
		...
		[Widget] Gtk.MenuItem menuitem_tic_solicitud = null;
		
		[Widget] Gtk.MenuItem menuitem_mtt = null;
		[Widget] Gtk.MenuItem menuitem_mtt_requi = null;
		
		[Widget] Gtk.MenuItem menuitem_intendencia = null;
		[Widget] Gtk.MenuItem menuitem_intendencia_requi = null;
		[Widget] Gtk.MenuItem menuitem_intendencia_solicitud = null;
		
		[Widget] Gtk.MenuItem menuitem_calidadmejora = null;
		[Widget] Gtk.MenuItem menuitem_calidadmejora_requi = null;
		[Widget] Gtk.MenuItem menuitem_calidadmejora_solicitud = null;
		
		[Widget] Gtk.MenuItem menuitem_adminstracion = null;
		[Widget] Gtk.MenuItem menuitem_admin_solicitud = null;
								
		[Widget] Gtk.MenuItem menuitem_tools_cat_empresas = null;

		// Salir
		[Widget] Gtk.Button button_salir  = null;
		[Widget] Gtk.Image osirislogo = null;
		...
		public programa_principal()
		{
			...
			pantalla_login();
			//new osiris.srvchat();
			//Console.WriteLine(SystemManager.GetOperatingSystem ());
			Console.WriteLine("Operating System Details");
			OperatingSystem os = Environment.OSVersion;
			Console.WriteLine("OS Version: " + os.Version.ToString());
			Console.WriteLine("OS Plataform: " + os.Platform.ToString());
			Console.WriteLine("OS SP: " + os.ServicePack.ToString());
			Console.WriteLine("OS Version String: " + os.VersionString.ToString());
			Console.WriteLine();
			// Get Version details
			Version ver = os.Version;
			Console.WriteLine("Mayor version: " + ver.Major);
			Console.WriteLine("Mayor Revision: " + ver.MajorRevision);
			Console.WriteLine("Menor version: " + ver.Minor);
			Console.WriteLine("Menor Revision: " + ver.MinorRevision);
		...
		void pantalla_login()
		{
			...
			imagelogin.Pixbuf = new Gdk.Pixbuf(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory,"login1.png"));
			...
			login_osiris.DeleteEvent += OnWindowDeleteEvent;

			//Gtk.ColorButton prueba = ColorButton(new 
			button_aceptar.ModifyBase(StateType.Normal, new Gdk.Color(254,253,152));		// Color Amarillo

			entry_login.ModifyBase(StateType.Normal, new Gdk.Color(254,253,152));		// Color Amarillo
			entry_password.ModifyBase(StateType.Normal, new Gdk.Color(254,253,152));		// Color Amarillo
		}
		...
		void pantalla_principal()
		{
			...
			gxml.Autoconnect (this);				 			
			osirislogo.Pixbuf = new Gdk.Pixbuf(System.IO.Path.Combine(System.AppDomain.CurrentDomain.BaseDirectory,"OSIRISLogo.png"));
			//osirislogo.Pixbuf = new Gdk.Pixbuf("/opt/osiris/bin/OSIRISLogo.png");   // en Linux
			menuprincipal.Show();
			...
			button_proveedores.Clicked += new EventHandler(on_button_proveedores_clicked);
			button_credito_cobranza.Clicked += new EventHandler(on_button_credito_cobranza_clicked);
			
			button_agredecimientos.Clicked += new EventHandler(on_button_agredecimientos_clicked);
			button_ocupacion_osiris.Clicked += new EventHandler(on_button_ocupacion_osiris_clicked);
			button_admisiones.Clicked += new EventHandler(on_button_admisiones_clicked);
			...
			menuitem_optica_paciente.Activated += new EventHandler(on_menuitem_optica_paciente_activated);
			menuitem_optica_solicitud.Activated += new EventHandler(on_menuitem_optica_solicitud_activated);
			menuitem_optica_devolucion.Activated += new EventHandler(on_menuitem_optica_devolucion_activated);
			menuitem_optica_inv.Activated += new EventHandler(on_menuitem_optica_inv_activated);
			
			menuitem_odonto_paciente.Activated += new EventHandler(on_menuitem_odonto_paciente_activated);
			menuitem_odontologia_requi.Activated += new EventHandler(on_menuitem_odontologia_requi_activated);
			menuitem_odontologia_solicitud.Activated += new EventHandler(on_menuitem_odontologia_solicitud_activated);
			...
			menuitem_hosp_paciente.Activated += new EventHandler(on_menuitem_hosp_paciente_activated);
			menuitem_hosp_rpt1.Activated += new EventHandler(on_menuitem_hosp_rpt1_activated);
			menuitem_hosp_rpt2.Activated += new EventHandler(on_menuitem_hosp_rpt2_activated);
			menuitem_hosp_rpt3.Activated += new EventHandler(on_menuitem_hosp_rpt3_activated);



			menuitem_consulta_paciente.Activated += new EventHandler(on_menuitem_consulta_paciente_activated);
			
			menuitem_tic_requi.Activated += new EventHandler(on_menuitem_tic_requi_activated);
			menuitem_tic_solicitud.Activated += new EventHandler(on_menuitem_tic_solicitud_activated);
			menuitem_mtt_requi.Activated += new EventHandler(on_menuitem_mtt_requi_activated);
			menuitem_intendencia_requi.Activated += new EventHandler(on_menuitem_intendencia_requi_activated);
			menuitem_intendencia_solicitud.Activated += new EventHandler(on_menuitem_intendencia_solicitud_activated);
			menuitem_calidadmejora_requi.Activated += new EventHandler(on_menuitem_calidadmejora_requi_activated);
			menuitem_calidadmejora_solicitud.Activated += new EventHandler(on_menuitem_calidadmejora_solicitud_activated);
			menuitem_admin_solicitud.Activated += new EventHandler(on_menuitem_admin_solicitud_activated);
			
			menuitem_admision_registro.Activated += new EventHandler(on_menuitem_admision_registro_activated);
			menuitem_admision_citas.Activated += new EventHandler(on_menuitem_admision_citas_activated);
			
			menuitem_tesoreria_caja.Activated += new EventHandler(on_menuitem_tesoreria_caja_activated);
			menuitem_tesoreria_facturador.Activated += new EventHandler(on_menuitem_tesoreria_facturador_activated);
			
			menuitem_optica_requi.Activated += new EventHandler(on_menuitem_optica_requi_activated);
			button_mantenimiento.Clicked += new EventHandler(on_menuitem_mtt_requi_activated);
			
			menuitem_costo_catalogoprod.Activated += new EventHandler(on_menuitem_costo_catalogoprod_activated);

			menuitem_tools_cat_empresas.Activated += new EventHandler(on_menuitem_tools_cat_empresas_activated);
		...
		void on_menuitem_tic_requi_activated(object o, EventArgs args)
		{
			...
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"TECNOLOGIAS DE LA INFORMACION",14,"AND osiris_grupo_producto.id_grupo_producto IN ('96','92') ",array_idtipoadmisiones,0);
		}
		
		void on_menuitem_odonto_paciente_activated(object o, EventArgs args)
		{
			new osiris.cargos_modulos_medicos(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,930,"ODONTOLOGIA",24,"");
		}
		
		void on_menuitem_odontologia_requi_activated(object o, EventArgs args)
		{
			int [] array_idtipoadmisiones = { 0, 930};
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"ODONTOLOGIA",930,"AND agrupacion8 IN ('ODO') ",array_idtipoadmisiones,0);
		}
		
		void on_menuitem_odontologia_solicitud_activated(object o, EventArgs args)
		{
				
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,24,0,0,"");
		}
		
		void on_menuitem_mtt_requi_activated(object o, EventArgs args)
		{
			int [] array_idtipoadmisiones = { 0, 4};
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"MANTENIMIENTO",4,"AND osiris_grupo_producto.id_grupo_producto IN ('6','87','92') ",array_idtipoadmisiones,0);
		}
		
		void on_menuitem_intendencia_requi_activated(object o, EventArgs args)
		{
			int [] array_idtipoadmisiones = { 0, 19};
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"INTENDENCIA",19,"AND AND osiris_grupo_producto.id_grupo_producto IN ('87') ",array_idtipoadmisiones,0);
		}
		
		void on_menuitem_optica_requi_activated(object o, EventArgs args)
		{
			int [] array_idtipoadmisiones = { 0, 970};
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"OPTICA",970,"AND osiris_grupo_producto.id_grupo_producto IN ('91') ",array_idtipoadmisiones,0);
		}
		
		void on_menuitem_calidadmejora_requi_activated(object o, EventArgs args)
		{
			int [] array_idtipoadmisiones = { 0, 20};
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"CALIDAD Y MEJORA CONTINUA",20,"AND osiris_grupo_producto.id_grupo_producto IN ('78') ",array_idtipoadmisiones,0);
		}
		
		void on_menuitem_calidadmejora_solicitud_activated(object o, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,21,0,0,"");
		}
		
		void on_menuitem_admin_solicitud_activated(object o, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,21,0,0,"");
		}
		
		void on_menuitem_tic_solicitud_activated(object o, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,21,0,0,"");
		}

		void on_menuitem_intendencia_solicitud_activated(object o, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,23,0,0,"");
		}
		...
		void on_menuitem_admision_registro_activated (object sender, EventArgs a)
		{
			new osiris.registro_paciente_busca("busca1",LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"");
		}
		
		void on_menuitem_admision_citas_activated(object sender, EventArgs a)
		{
		...
		{
			new osiris.reporte_pacientes_sin_alta(nombrebd,"OCUPACION");
		}

		// Vista rapida de Admisiones
		void on_button_admisiones_clicked(object sender, EventArgs a)
		{
			new osiris.reporte_pacientes_sin_alta(nombrebd,"ADMISIONES");
		}
		...
		void on_menuitem_hosp_paciente_activated(object sender, EventArgs args)
		{
			new osiris.cargos_modulos_medicos(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,500,"HOSPITALIZACION",3,"");
		}

		void on_menuitem_hosp_rpt1_activated(object sender, EventArgs args)
		{
			
		}

		// Pacientes que no tienen cargos (conceptos en cobros deta)
		void on_menuitem_hosp_rpt2_activated(object sender, EventArgs args)
		{
			// verificar por fecha y numero de atencion que no tienen cargos
		}

		void on_menuitem_hosp_rpt3_activated(object sender, EventArgs args)
		{
			// rpt_envio_mat_almacenes.cs
			new osiris.rpt_envio_almacen(nombrebd,3);
		}
		
		void on_menuitem_consulta_paciente_activated(object sender, EventArgs args)
		{
		...
		void on_menuitem_optica_paciente_activated(object sender, EventArgs args)
		{
		...
		void on_menuitem_optica_solicitud_activated(object sender, EventArgs args)
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,20,0,0,"");
		}

		void on_menuitem_optica_devolucion_activated(object sender, EventArgs args)
		{
		...
		void on_menuitem_optica_inv_activated(object sender, EventArgs args)
		{
		...
		void on_menuitem_tesoreria_caja_activated(object o, EventArgs args)
		{
		...
		void on_menuitem_tesoreria_facturador_activated(object o, EventArgs args)
		{
		...
		void on_menuitem_costo_catalogoprod_activated (object sender, EventArgs args)
		{
		...
		void on_menuitem_tools_cat_empresas_activated (object sender, EventArgs args)
		{
			new osiris.catalogo_empresas(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,1);
		}
		...
		void on_button_proveedores_clicked(object sender, EventArgs args)
		{
			new osiris.proveedores_remisiones(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd);
		}
		
		void on_button_credito_cobranza_clicked(object sender, EventArgs args)
		{
			new osiris.credito_cobranza(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd);
		}
        ...
        {        	
			...
			menuitem_hosp.Sensitive = false;
			menuitem_hosp_paciente.Sensitive = false;
			...
			menuitem_optica_paciente.Sensitive = false;
			menuitem_optica_solicitud.Sensitive = false;
			menuitem_optica_devolucion.Sensitive = false;
			menuitem_optica_traspaso.Sensitive = false;
			menuitem_optica_requi.Sensitive = false;
			
			button_odontologia.Sensitive = false;
			menuitem_odontologia.Sensitive = false;
			menuitem_odonto_paciente.Sensitive = false;
			menuitem_odontologia_solicitud.Sensitive = false;
			menuitem_odontologia_requi.Sensitive = false;		
			
			// ERP
			button_afiliados.Sensitive = false;
			menuitem_afiliados.Sensitive = false;
			
			button_registro_admision.Sensitive = false;
			menuitem_admision.Sensitive = false;
			
			button_caja.Sensitive = false;
			menuitem_tesoreria.Sensitive = false;
						
			button_compras.Sensitive = false;
			menuitem_compras.Sensitive = false;
			
			button_almacen.Sensitive = false;
			
			menuitem_almacen.Sensitive = false;
			
			button_costos.Sensitive = false;
			menuitem_costos.Sensitive = false;
			menuitem_costo_movprod.Sensitive = false;
			menuitem_costo_prodproce.Sensitive = false;
			menuitem_costo_costoproc.Sensitive = false;
			menuitem_costo_analisiscargos.Sensitive = false;
			menuitem_costo_listaprecio.Sensitive = false;
			menuitem_costo_catalogoprod.Sensitive = false;
			
			button_proveedores.Sensitive = false;
			menuitem_proveedores.Sensitive = false;
			
			button_credito_cobranza.Sensitive = false;
			menuitem_credcobranza.Sensitive = false;
			menuitem_credcbr_gestioncobranza.Sensitive = false;
			menuitem_credcbr_pagofacturas.Sensitive = false;
			menuitem_credcbr_convecuotas.Sensitive = false;
			menuitem_credcbr_docxvencer.Sensitive = false;
			menuitem_credcbr_docvencido.Sensitive = false;
			menuitem_credcbr_juridico.Sensitive = false;
			...
			menuitem_intendencia.Sensitive = false;
			
			menuitem_calidadmejora.Sensitive = false;
			
			menuitem_adminstracion.Sensitive = false;
						
			// opciones generales
			button_medicos.Sensitive = false;
			button_ocupacion_osiris.Sensitive = false;
			...
			if((bool) autorizaHIS == true){
				if ((string) accesoHIS.Substring(0,1) == "1"){
					...
					menuitem_hosp.Sensitive = true;
					menuitem_hosp_paciente.Sensitive = true;
        		}        		
				...
				if ((string) accesoHIS.Substring(13,1) == "1"){
					...
					menuitem_optica_paciente.Sensitive = true;
					menuitem_optica_solicitud.Sensitive = true;
					menuitem_optica_devolucion.Sensitive = true;
					menuitem_optica_traspaso.Sensitive = true;
					menuitem_optica_requi.Sensitive = true;
				}
				if ((string) accesoHIS.Substring(14,1) == "1"){
					button_odontologia.Sensitive = true;
					menuitem_odontologia.Sensitive = true;
					menuitem_odonto_paciente.Sensitive = true;
					menuitem_odontologia_solicitud.Sensitive = true;
					menuitem_odontologia_requi.Sensitive = true;
				}
			}
			if((bool) autorizaERP == true){
				if ((string) accesoERP.Substring(0,1) == "1"){
					button_afiliados.Sensitive = true;
					menuitem_afiliados.Sensitive = true;
				}
				if ((string) accesoERP.Substring(1,1) == "1"){
					button_registro_admision.Sensitive = true;
					menuitem_admision.Sensitive = true;
				}
				if ((string) accesoERP.Substring(2,1) == "1"){
					menuitem_tesoreria.Sensitive = true;
					button_caja.Sensitive = true;
				}
				if ((string) accesoERP.Substring(3,1) == "1"){
					button_compras.Sensitive = true;
					menuitem_compras.Sensitive = true;
				}
				if ((string) accesoERP.Substring(4,1) == "1"){
					menuitem_almacen.Sensitive = true;
					button_almacen.Sensitive = true;
				}
				if ((string) accesoERP.Substring(5,1) == "1"){
					button_costos.Sensitive = true;
					menuitem_costos.Sensitive = true;
					menuitem_costo_movprod.Sensitive = true;
					menuitem_costo_prodproce.Sensitive = true;
					menuitem_costo_costoproc.Sensitive = true;
					menuitem_costo_analisiscargos.Sensitive = true;
					menuitem_costo_listaprecio.Sensitive = true;
					menuitem_costo_catalogoprod.Sensitive = true;
				}
				if ((string) accesoERP.Substring(6,1) == "1"){
					button_proveedores.Sensitive = true;
					menuitem_proveedores.Sensitive = true;
				}
				if ((string) accesoERP.Substring(7,1) == "1"){
					button_credito_cobranza.Sensitive = true;
					menuitem_credcobranza.Sensitive = true;
					menuitem_credcbr_gestioncobranza.Sensitive = true;
					menuitem_credcbr_pagofacturas.Sensitive = true;
					menuitem_credcbr_convecuotas.Sensitive = true;
					menuitem_credcbr_docxvencer.Sensitive = true;
					menuitem_credcbr_docvencido.Sensitive = true;
					menuitem_credcbr_juridico.Sensitive = true;
				}
				...
				if ((string) accesoERP.Substring(13,1) == "1"){
					menuitem_tic.Sensitive = true;
				}
				if ((string) accesoERP.Substring(14,1) == "1"){
					menuitem_intendencia_requi.Sensitive = false;
					menuitem_intendencia.Sensitive = true;
				}
				if ((string) accesoERP.Substring(15,1) == "1"){
					menuitem_calidadmejora.Sensitive = true;
				}
				
				if ((string) accesoERP.Substring(16,1) == "1"){
					menuitem_adminstracion.Sensitive = true;
				}
			...
			if((bool) autorizaGENERAL == true){
				...
				if ((string) accesoGENERAL.Substring(1,1) == "1"){	
					button_ocupacion_osiris.Sensitive = true;
				}
