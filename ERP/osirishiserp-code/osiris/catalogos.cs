...
namespace osiris
{
	...
	{	
		...
		[Widget] Gtk.Button button_empresas = null;
		...
		[Widget] Gtk.Button button_selec_proveedor = null;
		[Widget] Gtk.Entry entry_nro_exterior = null;
		[Widget] Gtk.Entry entry_nro_interior = null;
		...
		{					
			...
			if (nomcatalogo=="cliente"){
				catalogo_clientes();
			}
			if (nomcatalogo=="cliente1"){
				catalogo_clientes();
			}
			if (nomcatalogo=="medicos"){
				catalogo_medicos();
			}
			if (nomcatalogo=="proveedores"){
...
//////////////////////////////////////////////MENU DE CATALOGOS/////////////////////////////////////////////////////
		void menu_de_catalogos()
		{
			...
			button_empresas.Clicked += new EventHandler(on_button_empresas_clicked);
		...
		void on_button_empresas_clicked(object sender, EventArgs args)
		{
		...
		{		
			...
			//entry_id_proveedor.KeyPressEvent += onKeyPressEvent_enter_id_proveedor;
			button_salir.Clicked += new EventHandler(on_cierraventanas_clicked);
				...
				msgBox.Run ();				msgBox.Destroy();
	 			if (miResultado == ResponseType.Yes){
					...
					numeroproveedor = int.Parse((string) lee_numero_proveedor())+1;
	    	       	...
	    	       	checkbutton_proveedor_activo.Active = true;
						...
						comando = conexion.CreateCommand ();
	 					comando.CommandText = "INSERT INTO osiris_erp_proveedores("+
											  ...
											  "fechahora_creacion_proveedor," +
												"noexterior_proveedor," +
												"nointerior_proveedor"+
												") VALUES ('"+
		 									  ...
		 									  (string) LoginEmpleado+"','"+
												...
												entry_nro_exterior.Text.ToUpper().Trim()+"','"+
												entry_nro_interior.Text.ToUpper().Trim()+
	 										  "');";
