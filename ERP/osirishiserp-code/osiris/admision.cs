...
namespace osiris
{
	public class admision
	{
		...
		[Widget] Gtk.Button button_documentos_admision = null;
		...
		public admision (string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string nombrebd_,bool accesocxpq_,bool accesocancelafolio_) 
		{
			...
			button_documentos_admision.Clicked += new EventHandler(on_button_documentos_admision_clicked);
		...
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,19,0,0,"");
		}
		...
		public void on_button_documentos_admision_clicked (object sender, EventArgs a)
		{
			string folioserv = "";
		...
		{
			new osiris.cambia_paciente(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,0);  // cambia_pacientes.cs
		}
