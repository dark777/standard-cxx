...
namespace osiris
{
	public class terapia_pediatrica
	{
		...
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,8,0,0,"");
		}
		...
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,8,"UNIDAD CUIDADOS INTENSIVOS PEDIATRIA",1,false);
		}
		
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,8,"UNIDAD CUIDADOS INTENSIVOS PEDIATRIA",2,false);
		}
