...
//				  Ing. Daniel Olivares C. (Adecuaciones y mejoras) arcangeldoc@openmailbox.org 05/10/2010
// Licencia		: GLP
//////////////////////////////////////////////////////////
//
...
namespace osiris
{
	public class rpt_envio_almacen
	{
		...
		public rpt_envio_almacen(string nombrebd_,int idsubalmacen_)		
		{
			...
			if (idsubalmacen != 1) {
				query_almacen = "AND osiris_his_solicitudes_deta.id_almacen = '" + idsubalmacen_.ToString ().Trim () + "' ";
			} else {
				query_almacen = "";
			}
