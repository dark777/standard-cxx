...
// 
//  25/05/2010   Ing. Daniel Olivares Cuevas (Programacion y Traspasado a GTKPrint) arcangeldoc@openmailbox.org
// 				  
// Licencia		: GLP
//////////////////////////////////////////////////////////
//
...
namespace osiris
{
	public class hoja_cargos
	{
		...
		void imprime_encabezado(Cairo.Context cr,Pango.Layout layout)
		{
			...
			desc.Size = (int)(fontSize * pangoScale);					layout.FontDescription = desc;
			layout.FontDescription.Weight = Weight.Bold;		// Letra negrita
			cr.MoveTo(225*escala_en_linux_windows, 25*escala_en_linux_windows);			layout.SetText("HOJA CARGOS DE "+area);				Pango.CairoHelper.ShowLayout (cr, layout);
			fontSize = 8.0;	
			desc.Size = (int)(fontSize * pangoScale);					layout.FontDescription = desc;
			layout.FontDescription.Weight = Weight.Bold;		// Letra negrita
