...
namespace osiris
{
	public class hospitalizacion
	{
		...
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,3,0,0,"");
		}
		...
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,3,"HOSPITALIZACION",1,false);
		}
		...
		{
			new osiris.trasp_devolu_materiales(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,3,"HOSPITALIZACION",1,"DEVOLUCION",false,1);
		}
		...
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			...
			new osiris.trasp_devolu_materiales(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,3,"HOSPITALIZACION",2,"TRASPASO",false,1);
		}

		void on_button_caducos_clicked(object sender, EventArgs args)
		{
			//new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,3,"HOSPITALIZACION",2);
			new osiris.trasp_devolu_materiales(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,3,"HOSPITALIZACION",3,"CADUCOS",false,11);
		}
