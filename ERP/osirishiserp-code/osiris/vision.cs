...
namespace osiris
{
	public class vision
	{
		...
		[Widget] Gtk.Button button18 = null;
		...
		[Widget] Gtk.Label label215 = null;
		...
		public vision (string LoginEmp_, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_, string nombrebd_)
		{
			...
			label215.Text = "Solicitudes Vision";
			////// Sale de la ventana
			...
			button18.Clicked += new EventHandler(on_button_solicitud_examenes_clicked);
		}
		...
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,15,0,0,"");
		}
		...
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,15,"VISION",1,false);
		}
		
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,15,"VISION",2,false);
		}
		...
		{
			new osiris.solicitudes_rx_lab(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"VISION",960);
		}
		...
		void imprime_reporte_vision(object sender, EventArgs args)
		{
			...
			if(checkbutton_export_to.Active == true){
				string query_sql = "SELECT osiris_erp_cobros_deta.folio_de_servicio AS foliodeservicio,to_char(osiris_erp_cobros_deta.pid_paciente,'9999999999') AS pidpaciente," +
									...
									"osiris_erp_cobros_enca.total_pago,osiris_erp_cobros_enca.monto_convenio "+
									...
									query_rango_fechas;
				string[] args_names_field = {"fecha","nombrepaciente","edad","foliodeservicio","pidpaciente","idproducto","descripcion_producto","total_pago","monto_convenio","tipo_de_paciente","dr_solicita","medicotratante","tecnico"};
				string[] args_type_field = {"string","string","string","float","float","string","string","float","float","string","string","string","string"};
