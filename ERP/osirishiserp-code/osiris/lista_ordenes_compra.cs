...
// Monterrey - Mexico
//
// Autor    	: Ing. Daniel Olivares C. arcangeldoc@openmailbox.org
// Licencia		: GLP
//////////////////////////////////////////////////////////
//
...
namespace osiris
{
	public class lista_ordenes_compra
	{
		...
		[Widget] Gtk.CheckButton checkbutton_addconceptos = null;
		...
		void on_buscar_ordencompra_clicked(object sender, EventArgs args)
		{
			...
			if(checkbutton_filtro.Active == true){
				query_filtro_prove = "AND osiris_erp_ordenes_compras_enca.id_proveedor = '"+entry_id_proveedor.Text.Trim()+"' ";
			}else{
				query_filtro_prove = "";
			}
