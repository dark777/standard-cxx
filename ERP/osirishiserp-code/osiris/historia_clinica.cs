...
//
// mejoras Ing. Daniel Olivares Cuevas 25/07/2011 arcangeldoc@openmailbox.org (Programation & Glade's window)
//
// Licencia		: GLP
//////////////////////////////////////////////////////////
//
...
namespace osiris
{
	...
	public class his_consulta_medica
	{
		// consulta de oftalmologia
		[Widget] Gtk.Window consulta_medica = null;
		...
		[Widget] Gtk.TreeView treeview_visitas_anter = null;
		Gtk.TreeStore treeViewEngine_visant = null;
		[Widget] Gtk.TextView textview_hc_oftal = null;
		[Widget] Gtk.Button button_imprime_hc = null;
		[Widget] Gtk.Button button_guarda_hcoftal = null;
		...
		[Widget] Gtk.TextView textview_observacion = null;			
		[Widget] Gtk.Button button_salir;
		...
		public his_consulta_medica(string LoginEmp, string NomEmpleado_, string AppEmpleado_, string ApmEmpleado_,
		                      string pidpaciente_,string folioservicio_,string iddoctor_,string nombredoctor_,string nombrepaciente_,
		                      bool altapaciente_,string edadpaciente_, string diagnosticoadmision_,int idespecialidad)
		{
			connectionString = conexion_a_DB._url_servidor+conexion_a_DB._port_DB+conexion_a_DB._usuario_DB+conexion_a_DB._passwrd_user_DB;
			nombrebd = conexion_a_DB._nombrebd;
			LoginEmpleado = LoginEmp;
			...
			Glade.XML gxml = new Glade.XML (null, "hospitalizacion.glade", "consulta_medica", null);
			gxml.Autoconnect (this);        
