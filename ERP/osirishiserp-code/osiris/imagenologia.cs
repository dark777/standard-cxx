...
namespace osiris
{
	public class imagenologia
	{
		...
		void on_button_requisicion_materiales_clicked(object sender, EventArgs args)
		{
			...
			string acceso_a_grupos = "AND osiris_grupo_producto.id_grupo_producto IN ("+(string) classpublic.lee_registro_de_tabla("osiris_his_tipo_admisiones","id_grupoprod_requisicion"," WHERE osiris_his_tipo_admisiones.id_tipo_admisiones = '300' ","id_grupoprod_requisicion","string")+")";
			new osiris.requisicion_materiales_compras(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,"IMAGENOLOGIA",300,acceso_a_grupos,array_idtipoadmisiones,0);
		}
