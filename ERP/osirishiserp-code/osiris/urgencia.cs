...
namespace osiris
{
	public class urgencia
	{
		...
		{
			new osiris.solicitud_material(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,4,0,0,"");
		}
		...
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,4,"URGENCIAS",1,false);
		}
		
		void on_button_traspaso_subalmacenes_clicked(object sender, EventArgs args)
		{
			new osiris.inventario_sub_almacen(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,4,"URGENCIAS",2,false);
		}

		void on_button_devolucion_mat_clicked(object sender, EventArgs args)
		{
			new osiris.trasp_devolu_materiales(LoginEmpleado,NomEmpleado,AppEmpleado,ApmEmpleado,nombrebd,4,"URGENCIAS",1,"DEVOLUCION",false,1);
		}
