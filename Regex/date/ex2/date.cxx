...
struct date
{
 ...
 bool isDate()
 {
  ...
  const std::regex pattern(R"(^(?:\d{4}([/])(?:(?:(?:(?:0?[13578]|1[02]|[Jj](?:an|ul)|[Mm]a[ry]|[Aa]ug|[Oo]ct|[Dd]ec)([/])(?:0?[1-9]|[1-2][0-9]|3[01]))|(?:(?:0?[469]|11|[Aa]pr|[Jj]un|[Ss]ep|[Nn]ov)([/])(?:0?[1-9]|[1-2][0-9]|30))|(?:(0?2|[Ff]eb)([/])(?:0?[1-9]|1[0-9]|2[0-8]))))|(?:(?:\d{2}(?:0[48]|[2468][048]|[13579][26]))|(?:(?:[02468][048])|[13579][26])00)([/])(0?2|[Ff]eb)([/])29)$)"); 
